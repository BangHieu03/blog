div id="kt_header"  class="header align-items-stretch">
						...
						<div class="header-brand">
							...
							<a href="../../demo8/dist/index.html">
								<img alt="Logo" src="assets/media/logos/logo.png" class="h-100px h-lg-100px" />
							</a>
							<!--end::Logo-->
											...
											<div class="d-flex align-items-center">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
													...
													<div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('assets/media/misc/pattern-1.jpg')">
														...
														<span class="fs-8 opacity-75 ps-3">24 báo cáo</span></h3>
														<!--end::Title-->
														<!--begin::Tabs-->
															...
															<div class="scroll-y mh-325px my-5 px-8">
																...
																<div class="d-flex flex-stack py-4">
																	...
																	<div class="d-flex align-items-center">
																		...
																		<!--begin::Title-->
																		<div class="mb-0 me-2">
																			<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Dự án Alice</a>
																			<div class="text-gray-400 fs-7">Phát triển giai đoạn 1</div>
																		</div>
																		<!--end::Title-->
																	</div>
																	<!--end::Section-->
