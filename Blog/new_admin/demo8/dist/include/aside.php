							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<div class="menu-content pt-8 pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">thủ công</span>
									</div>
								</div>
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div class="menu-item">
													<a class="menu-link" href="../../demo8/dist/pages/profile/documents.html">
														...
														<span class="menu-title">Các tài liệu</span>
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="../../demo8/dist/pages/profile/connections.html">
														...
														<span class="menu-title">Kết nối</span>
													</a>
												</div>
												<div class="menu-item">
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												<div class="menu-item">
													<a class="menu-link" href="../../demo8/dist/pages/search/horizontal.html">
														...
														<span class="menu-title">Nằm ngang</span>
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="../../demo8/dist/pages/search/vertical.html">
														...
														<span class="menu-title">Thẳng đứng</span>
													</a>
												</div>
											</div>
										</div>
