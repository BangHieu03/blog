    ...
    <div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
        ...
        <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
            ...
            <div class="symbol symbol-50px">
                <img src="../demo8/dist/assets/media/avatars/150-26.jpg" alt="" />
            </div>
            <!--end::Symbol-->
            <!--begin::Wrapper-->
            <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                ...
                <div class="d-flex">
                    ...
                    <div class="flex-grow-1 me-2">
                        ...
                        <!--end::Username-->
                        <!--begin::Description-->
                        <span class="text-gray-600 fw-bold d-block fs-8 mb-1">Quản trị</span>
                        <!--end::Description-->
                        <!--begin::Label-->
                    ...
                    <div class="me-n2">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="../demo8/dist/assets/media/avatars/150-26.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                            ...
                            <div class="menu-item px-5">
                                <a href="../../demo8/dist/account/overview.html" class="menu-link px-5">Thông tin của tôi</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                            ...
                            <div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                                <a href="#" class="menu-link px-5">
                                    <span class="menu-title">Đăng ký của tôi</span>
                                ...
                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/referrals.html" class="menu-link px-5">Giới thiệu</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/billing.html" class="menu-link px-5">thanh toán</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/statements.html" class="menu-link px-5">thanh toán</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="../../demo8/dist/account/statements.html" class="menu-link d-flex flex-stack px-5">Các câu lệnh
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content px-3">
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                ...
                                                <span class="form-check-label text-muted fs-7">Thông báo</span>
                                            </label>
                                        </div>
                                    </div>
                                    <!--end::Menu item-->
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                                <a href="../../demo8/dist/account/statements.html" class="menu-link px-5">Tuyên bố của tôi</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu separator-->
                            <div class="separator my-2"></div>
                            ...
                            <div class="menu-item px-5 my-1">
                                <a href="../../demo8/dist/account/settings.html" class="menu-link px-5">Cài đặt tài khoản</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-5">
                            ...
                            <div class="menu-item px-5">
                                <div class="menu-content px-5">
                                    <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="kt_user_menu_dark_mode_toggle">
                                        <input class="form-check-input w-30px h-20px" type="checkbox" value="1" name="mode" id="kt_user_menu_dark_mode_toggle" data-kt-url="./index.php?pages=index&action=home" />
        ...
        <div class="aside-search py-5">
            ...
            <div id="kt_header_search" class="d-flex align-items-center" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start" data-kt-menu-flip="bottom">
                ...
                <form data-kt-search-element="form" class="w-100 position-relative" autocomplete="off">
                    ...
                    <!--end::Icon-->
                    <!--begin::Input-->
                    <input type="text" class="form-control ps-13 fs-7 h-40px" name="search" value="" placeholder="Tìm kiếm" data-kt-search-element="input" />
                    <!--end::Input-->
                    <!--begin::Spinner-->
                ...
                <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown w-300px w-md-350px py-7 px-7 overflow-hidden">
                    ...
                    <div data-kt-search-element="wrapper">
                        ...
                        <div data-kt-search-element="results" class="d-none">
                            ...
                            <div class="scroll-y mh-200px mh-lg-350px">
                                ...
                                <h3 class="fs-5 text-muted m-0 pb-5" data-kt-search-element="category-title">Người dùng</h3>
                                <!--end::Category title-->
                                <!--begin::Item-->
                                ...
                                <!--end::Item-->
                                <!--begin::Category title-->
                                <h3 class="fs-5 text-muted m-0 pt-5 pb-5" data-kt-search-element="category-title">Khách hàng</h3>
                                <!--end::Category title-->
                                <!--begin::Item-->
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                        <span class="fs-6 fw-bold">Xây dựng thương hiệu công ty</span>
                                        <span class="fs-7 fw-bold text-muted">Thiết kế giao diện người dùng</span>
                                    </div>
                                    <!--end::Title-->
                                </a>
                                <!--end::Item-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                        <span class="fs-6 fw-bold">Tái xây dựng thương hiệu công ty</span>
                                        <span class="fs-7 fw-bold text-muted">Phát triển web</span>
                                    </div>
                                    <!--end::Title-->
                                </a>
                                <!--end::Item-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                        <span class="fs-6 fw-bold">Ứng dụng phân tích doanh nghiệp</span>
                                        <span class="fs-7 fw-bold text-muted">Sự quản lý</span>
                                    </div>
                                    <!--end::Title-->
                                </a>
                                <!--end::Item-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                        <span class="fs-6 fw-bold">Ra mắt ứng dụng EcoLeaf</span>
                                        <span class="fs-7 fw-bold text-muted">Tiếp thị</span>
                                    </div>
                                    <!--end::Title-->
                                </a>
                                <!--end::Item-->
                                ...
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column justify-content-start fw-bold">
                                        <span class="fs-6 fw-bold">Trang web của Tập đoàn Tower</span>
                                ...
                                <!--end::Item-->
                                <!--begin::Category title-->
                                <h3 class="fs-5 text-muted m-0 pt-5 pb-5" data-kt-search-element="category-title">Dự án</h3>
                                <!--end::Category title-->
                                <!--begin::Item-->
                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                    <!--begin::Symbol-->
                        ...
                        <div data-kt-search-element="main">
                            ...
                            <div class="scroll-y mh-200px mh-lg-325px">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <!--begin::Title-->
                                    <div class="d-flex flex-column">
                                        <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Ra mắt ứng dụng giám sát KPI</a>
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="pb-15 fw-bold">
                                <h3 class="text-gray-600 fs-5 mb-2">Không có kết quả nào</h3>
                                <div class="text-muted fs-7">Vui lòng thử lại với một truy vấn khác</div>
                            </div>
                            <!--end::Message-->
                        </div>
                        <!--end::Empty-->
                    ...
                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                        ...
                        <!--begin::Input group-->
                        <div class="mb-5">
                            <input type="text" class="form-control form-control-sm form-control-solid" placeholder="Chứa từ" name="query" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-5">
                            ...
                            <div class="nav-group nav-group-fluid">
                                ...
                                <label>
                                    ...
                                    <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">người dùng</span>
                                </label>
                                <!--end::Option-->
                                <!--begin::Option-->
                                <label>
                                    <input type="radio" class="btn-check" name="type" value="orders" />
                                    <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Đơn đặt hàng</span>
                                </label>
                                <!--end::Option-->
                                <!--begin::Option-->
                                <label>
                                    <input type="radio" class="btn-check" name="type" value="projects" />
                                    <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Dự án</span>
                                </label>
                                <!--end::Option-->
                            </div>
                            <!--end::Radio group-->
                        ...
                        <!--begin::Input group-->
                        <div class="mb-5">
                            <input type="text" name="assignedto" class="form-control form-control-sm form-control-solid" placeholder="Phân công" value="" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-5">
                            <input type="text" name="collaborators" class="form-control form-control-sm form-control-solid" placeholder="Cộng tác viên" value="" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="mb-5">
                            ...
                            <div class="nav-group nav-group-fluid">
                                ...
                                <label>
                                    ...
                                    <span class="btn btn-sm btn-color-muted btn-active btn-active-primary">có tập tin đính kèm</span>
                                </label>
                                <!--end::Option-->
                                <!--begin::Option-->
                                <label>
                                    <input type="radio" class="btn-check" name="attachment" value="any" />
                                    <span class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Bất kì</span>
                                </label>
                                <!--end::Option-->
                            </div>
                            <!--end::Radio group-->
                        ...
                        <div class="mb-5">
                            <select name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="date_period" class="form-select form-select-sm form-select-solid">
                                <option value="next">Trong vòng tiếp theo</option>
                                <option value="last">Trong vòng cuối cùng</option>
                                <option value="between">Giữa</option>
                                <option value="on">TRÊN</option>
                            </select>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                    ...
                    <form data-kt-search-element="preferences" class="pt-1 d-none">
                        <!--begin::Heading-->
                        <h3 class="fw-bold text-dark mb-7">Tùy chọn tìm kiếm</h3>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="pb-4 border-bottom">
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">dự án</span>
                        ...
                        <div class="py-4 border-bottom">
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">Mục tiêu</span>
                                <input class="form-check-input" type="checkbox" value="1" checked="checked" />
                            </label>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="py-4 border-bottom">
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">Chương trình liên kết</span>
                        ...
                        <div class="py-4 border-bottom">
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">Giới thiệu</span>
                                <input class="form-check-input" type="checkbox" value="1" checked="checked" />
                            </label>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="py-4 border-bottom">
                            <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                                <span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">người dùng</span>
                                <input class="form-check-input" type="checkbox" value="1" />
                            </label>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="d-flex justify-content-end pt-7">
                            ...
                            <button type="submit" class="btn btn-sm fw-bolder btn-primary">Lưu thay đổi</button>
                        </div>
                        <!--end::Actions-->
                    </form>
                    <!--end::Preferences-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item">
                    <a class="menu-link active" href="./index.php?pages=index&action=home">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="./index.php?pages=customers&action=list">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Danh sách</span>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/pages/faq/classic.html">
                                        ...
                                        <span class="menu-title">Cổ điển</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/pages/faq/extended.html">
                                        ...
                                        <span class="menu-title">Mở rộng</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/account/security.html">
                                ...
                                <span class="menu-title">Bảo vệ</span>
                            </a>
                        </div>
                        <div class="menu-item">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/account/statements.html">
                                ...
                                <span class="menu-title">Các câu lệnh</span>
                            </a>
                        </div>
                        <div class="menu-item">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/account/api-keys.html">
                                ...
                                <span class="menu-title">Khóa API</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Xác thực</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <span class="menu-link">
                                ...
                                <span class="menu-title">Luồng cơ bản</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/authentication/flows/basic/two-steps.html">
                                        ...
                                        <span class="menu-title">Hai bước</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/authentication/flows/basic/password-reset.html">
                                        ...
                                        <span class="menu-title">Đặt lại mật khẩu</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/authentication/flows/basic/new-password.html">
                                        ...
                                        <span class="menu-title">mật khẩu mới</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/extended/multi-steps-sign-up.html">
                                ...
                                <span class="menu-title">Đăng ký nhiều bước</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/extended/free-trial-sign-up.html">
                                ...
                                <span class="menu-title">Đăng ký dùng thử miễn phí</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/extended/coming-soon.html">
                                ...
                                <span class="menu-title">Sắp ra mắt</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/general/welcome.html">
                                ...
                                <span class="menu-title">Tin nhắn chào mừng</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/general/verify-email.html">
                                ...
                                <span class="menu-title">Xác nhận Email</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/general/password-confirmation.html">
                                ...
                                <span class="menu-title">Xác nhận mật khẩu</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/general/deactivation.html">
                                ...
                                <span class="menu-title">Vô hiệu hóa tài khoản</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/general/error-404.html">
                                ...
                                <span class="menu-title">lỗi 404</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/authentication/general/error-500.html">
                                ...
                                <span class="menu-title">lỗi 500</span>
                            </a>
                        </div>
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <span class="menu-link">
                                ...
                                <span class="menu-title">mẫu thư điện tử</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/authentication/email/invitation.html" target="blank">
                                        ...
                                        <span class="menu-title">Lời mời tài khoản</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo8/dist/authentication/email/password-change.html" target="blank">
                                        ...
                                        <span class="menu-title">Mật khẩu đã được thay đổi</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Ứng dụng</span>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/apps/subscriptions/list.html">
                                ...
                                <span class="menu-title">Danh sách đăng ký</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/apps/subscriptions/add.html">
                                ...
                                <span class="menu-title">Thêm đăng ký</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <span class="menu-link">
                        ...
                        <span class="menu-title">Trò chuyện</span>
                        <span class="menu-arrow"></span>
                    </span>
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/apps/chat/private.html">
                                ...
                                <span class="menu-title">Trò chuyện riêng tư</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="../../demo8/dist/apps/chat/group.html">
                                ...
                                <span class="menu-title">Trò chuyện nhóm</span>
                            </a>
                        </div>
                    </div>
                </div>
