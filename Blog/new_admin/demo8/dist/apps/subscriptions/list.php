								...
								<div class="me-n2">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
										...
										<div class="menu-item px-5">
											<a href="../../demo8/dist/account/overview.html"
												class="menu-link px-5">Thông tin của tôi</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											...
											<div class="menu-sub menu-sub-dropdown w-175px py-4">
												...
												<div class="menu-item px-3">
													<a href="../../demo8/dist/account/referrals.html"
														class="menu-link px-5">Giới thiệu</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="../../demo8/dist/account/billing.html"
														class="menu-link px-5">thanh toán</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
												...
												<div class="menu-item px-3">
													<a href="../../demo8/dist/account/statements.html"
														class="menu-link d-flex flex-stack px-5">Các câu lệnh
													...
													<div class="menu-content px-3">
														<label
															...
															<input class="form-check-input w-30px h-20px"
																...
																name="notifications" />
															<span class="form-check-label text-muted fs-7">Thông
																báo</span>
														</label>
													</div>
												</div>
										...
										<div class="menu-item px-5">
											<a href="../../demo8/dist/account/statements.html"
												class="menu-link px-5">Tuyên bố của tôi</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu separator-->
										<div class="separator my-2"></div>
										...
										<div class="menu-item px-5 my-1">
											<a href="../../demo8/dist/account/settings.html" class="menu-link px-5">Cài
												đặt tài khoản</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
									...
									<div data-kt-search-element="results" class="d-none">
										...
										<div class="scroll-y mh-200px mh-lg-350px">
											...
											<h3 class="fs-5 text-muted m-0 pb-5"
												data-kt-search-element="category-title">Người dùng</h3>
											<!--end::Category title-->
											<!--begin::Item-->
											<a href="#"
											...
											<h3 class="fs-5 text-muted m-0 pt-5 pb-5"
												data-kt-search-element="category-title">Khách hàng</h3>
											<!--end::Category title-->
											<!--begin::Item-->
											<a href="#"
												class="d-flex text-dark text-hover-primary align-items-center mb-5">
												...
												<div class="d-flex flex-column justify-content-start fw-bold">
													...
													<span class="fs-7 fw-bold text-muted">Thiết kế giao diện người
														dùng</span>
												</div>
												<!--end::Title-->
											</a>
											...
											<!--begin::Category title-->
											<h3 class="fs-5 text-muted m-0 pt-5 pb-5"
												data-kt-search-element="category-title">Dự án</h3>
											<!--end::Category title-->
											<!--begin::Item-->
											<a href="#"
												class="d-flex text-dark text-hover-primary align-items-center mb-5">
									...
									<div data-kt-search-element="main">
										...
										<div class="scroll-y mh-200px mh-lg-325px">
											...
											<div class="d-flex align-items-center mb-5">
												...
												<!--begin::Title-->
												<div class="d-flex flex-column">
													<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Ra
														mắt ứng dụng giám sát KPI</a>
								...
								<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
									...
									<div class="mb-5">
										<input type="text" class="form-control form-control-sm form-control-solid"
											placeholder="Chứa từ" name="query" />
									</div>
									<!--end::Input group-->
									<!--begin::Input group-->
									<div class="mb-5">
										...
										<div class="nav-group nav-group-fluid">
											...
											<label>
												<input type="radio" class="btn-check" name="type" value="has"
													checked="checked" />
												<span
													class="btn btn-sm btn-color-muted btn-active btn-active-primary">tất
													cả</span>
											</label>
											<!--end::Option-->
											<!--begin::Option-->
											<label>
												...
												<span
													class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">người
													dùng</span>
											</label>
											<!--end::Option-->
											<!--begin::Option-->
											<label>
												...
												<span
													class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Đơn
													đặt hàng</span>
											</label>
											<!--end::Option-->
											<!--begin::Option-->
											<label>
												...
												<span
													class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Dự
													án</span>
											</label>
											<!--end::Option-->
										</div>
									...
									<div class="mb-5">
										<input type="text" name="collaborators"
											class="form-control form-control-sm form-control-solid"
											placeholder="Cộng tác viên" value="" />
									</div>
									<!--end::Input group-->
									<!--begin::Input group-->
									<div class="mb-5">
										...
										<div class="nav-group nav-group-fluid">
											...
											<label>
												<input type="radio" class="btn-check" name="attachment" value="has"
													checked="checked" />
												<span
													class="btn btn-sm btn-color-muted btn-active btn-active-primary">có
													tập tin đính kèm</span>
											</label>
											<!--end::Option-->
											<!--begin::Option-->
											<label>
												...
												<span
													class="btn btn-sm btn-color-muted btn-active btn-active-primary px-4">Bất
													kì</span>
											</label>
											<!--end::Option-->
										</div>
								...
								<form data-kt-search-element="preferences" class="pt-1 d-none">
									...
									<div class="pb-4 border-bottom">
										<label
											...
											<span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">dự
												án</span>
									...
									<div class="py-4 border-bottom">
										<label
											class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
											<span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">Mục
												tiêu</span>
											<input class="form-check-input" type="checkbox" value="1"
												checked="checked" />
										</label>
									...
									<div class="py-4 border-bottom">
										<label
											class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
											<span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">Chương
												trình liên kết</span>
											<input class="form-check-input" type="checkbox" value="1" />
										</label>
									</div>
									...
									<div class="py-4 border-bottom">
										<label
											class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
											<span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">Giới
												thiệu</span>
											<input class="form-check-input" type="checkbox" value="1"
												checked="checked" />
										</label>
									...
									<div class="py-4 border-bottom">
										<label
											class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
											<span class="form-check-label text-gray-700 fs-6 fw-bold ms-0 me-2">người
												dùng</span>
											<input class="form-check-input" type="checkbox" value="1" />
										</label>
									</div>
									...
									<div class="d-flex justify-content-end pt-7">
										...
										<button type="submit" class="btn btn-sm fw-bolder btn-primary">Lưu thay
											đổi</button>
									</div>
									<!--end::Actions-->
								</form>
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
							...
							<div class="menu-item">
								<div class="menu-content pb-2">
									<span class="menu-section text-muted text-uppercase fs-8 ls-1">bảng điều
										khiển</span>
								</div>
							</div>
							<div class="menu-item">
												...
												<div class="px-7 py-5" data-kt-subscription-table-filter="form">
													...
													<div class="mb-10">
														...
														<select class="form-select form-select-solid fw-bolder"
															...
															<option value="Expiring">Chưa hoạt động</option>
