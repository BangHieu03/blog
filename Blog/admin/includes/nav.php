...
>>>>>>> 14f18fc ([TASK]-GHÉP CODE[POST...] ĐI ĐƯỜNG DẪN)
        ...
        <a class="nav-link" href="./index.php?act=users&action=list">
          <div class="sb-nav-link-icon"><i class="fas fa-user" style="color: #24e3a2;"></i></div>
          NGƯỜI DÙNG
        </a>
...
>>>>>>> 14f18fc ([TASK]-GHÉP CODE[POST...] ĐI ĐƯỜNG DẪN)
        ...
        <a class="nav-link" href="./index.php?act=comment&action=list">
          <div class="sb-nav-link-icon"><i class="fas fa-comments" style="color: #24e3a2;"></i></div>
          BÌNH LUẬN
        </a>
      </div>
    </div>
